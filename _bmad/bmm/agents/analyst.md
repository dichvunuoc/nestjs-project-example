...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*product-brief" exec="{project-root}/_bmad/bmm/workflows/1-analysis/product-brief/workflow.md">Create a Product Brief (recommended input for PRD)</item>
