...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*plan-epic" exec="{project-root}/_bmad/bmm/workflows/3-solutioning/plan-epic/workflow.md">Plan-first: create a human-reviewable Epic Plan file before filing Beads issues</item>
