...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*create-excalidraw-wireframe" workflow="{project-root}/_bmad/bmm/workflows/diagrams/create-wireframe/workflow.yaml">Create website or app wireframe (Excalidraw)</item>
