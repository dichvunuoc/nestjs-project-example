...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="*list-tasks" action="list all tasks from {project-root}/bmad/_config/task-manifest.csv">List Available Tasks</item>
    <item cmd="*list-workflows" action="list all workflows from {project-root}/bmad/_config/workflow-manifest.csv">List Workflows</item>
